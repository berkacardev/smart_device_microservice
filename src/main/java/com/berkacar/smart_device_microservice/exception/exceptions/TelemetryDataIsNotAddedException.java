...
@Slf4j
@Getter
public class TelemetryDataIsNotAddedException extends RuntimeException{
    private Language language;
    private FriendlyMessageCode friendlyMessageCode;

    public TelemetryDataIsNotAddedException() {

    }
    public TelemetryDataIsNotAddedException(Language language, FriendlyMessageCode friendlyMessageCode, String message) {
